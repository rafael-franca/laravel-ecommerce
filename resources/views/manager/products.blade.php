...
<div class="container">
    ...
    <div class="d-flex mb-3">
        <ul class="nav mr-auto">
            <li>
                <a class="btn btn-primary" href="{{ route('manager.list_products') }}" role="button">Published</a>
            </li>
            <li>
                @can('drafts', App\Product::class)
                <a class="btn btn-link" href="{{ route('manager.list_drafts') }}" role="button">Drafts</a>
                @endcan
            </li>
        </ul>
