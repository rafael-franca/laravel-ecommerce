    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('manager.create_product') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="barcode" type="slug" class="form-control{{ $errors->has('barcode') ? ' is-invalid' : '' }}" name="barcode" value="{{ old('barcode') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="image" type="slug" class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" name="image" value="{{ old('image') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group mb-2">
                                    ...
                                    <input id="price" type="slug" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" value="{{ old('price') }}" required>
                                </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <label class="form-check-label">
                                    <input type="checkbox" class="form-check-input" name="published" value="1" {{ old('published') ? 'checked' : '' }}>
                                    Publish Product?
                                </label>
